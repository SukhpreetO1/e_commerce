...
<script>
   ...
   $(document).off('submit', '#add_products_form').on('submit', '#add_products_form', function (e) {
      ...
      var is_valid_images = validate_products_images();
      if (!is_valid_name || !is_valid_description || !is_valid_title || !is_valid_quantity || !is_valid_price || !is_valid_discount || !is_valid_images) {
         return false;
      } else {
   ...
   $(document).on('input', '#add_products_form', function (e) {
      ...
      var is_valid_discount = validate_products_discount();
      var is_valid_images = validate_products_images();
      if (!is_valid_name || !is_valid_description || !is_valid_quantity || !is_valid_price || !is_valid_discount || !is_valid_images) {
         return false;
      }
   });
