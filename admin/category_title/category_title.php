    ...
    function category_title_plus_icon(url) {
        $.ajax({
            ...
            success: function(data) {
                $(".container").empty();
                $('.container').html(data);
                var new_url = window.location.href.replace('?tab=category_title', '?tab=add_category_title');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (!$(data).find('.homepage_sidebar').length) {
                    container.html(data);
                    var new_url = window.location.href.replace('?tab=category_title', '?tab=dashboard');
                    history.pushState(null, null, new_url);
                }
            },
            error: function(e) {
